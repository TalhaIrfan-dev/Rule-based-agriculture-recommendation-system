...
Traditional farming decisions are commonly influenced by previous seasons’ demand, market prices, or neighboring farming practices. When adopted at scale, this approach leads to:

- Overproduction of specific crops  
- Reduced profitability for farmers  
- Poor soil–crop alignment  
...
- Provide **soil–crop suitability analysis**
...
|   └── index.html
├── 📄 README.md
├── 📄 Digital-Agriculture-Recommender-System-DARS.pptx
...
## ⚙️ Methods / System Approach

- Rule-based recommendation logic using **IF–THEN rules**
...
> ❌ No Artificial Intelligence or Machine Learning techniques are used to maintain transparency and simplicity.
